...
class PercentageArcUtilTest: XCTestCase {
    ...
    func test1FindCentre() {
        let result = PercentageArcUtil.findCentre(
    ...
    func test2FindCentre() {
        let result = PercentageArcUtil.findCentre(
            rect: CGRect(x: 1, y: 8, width: 20, height: 30))
    ...
    func test2FindRadius() {
        let result = PercentageArcUtil.findRadius(
            rect: CGRect(x: 3, y: 20, width: 30, height: 100))
    ...
    func test1MakePercentageAngle() {
        let result = PercentageArcUtil.makePercentageAngle(
            percentage: 0.5,
            start: PercentageArcUtil.top)
    ...
    func test3MakePercentageAngle() {
        let result = PercentageArcUtil.makePercentageAngle(
            percentage: 0.5,
            start: PercentageArcUtil.bottom)
